...
func TestPublicKey_Add(t *testing.T) {
	...
	ct2, _ := pk.Encrypt(new(big.Int).SetInt64(2))
	ct245, _ := pk.Encrypt(new(big.Int).SetInt64(245))
...
func TestPublicKey_MultPlaintext(t *testing.T) {
	...
	ct2, _ := pk.Encrypt(new(big.Int).SetInt64(2))
	ct36, _ := pk.Encrypt(new(big.Int).SetInt64(36))
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := pk.MultPlaintext(tt.args.ct, new(big.Int).SetInt64(tt.args.pt))
			if (err != nil) != tt.wantErr {
...
func TestPublicKey_AddPlaintext(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := pk.AddPlaintext(tt.args.ct, new(big.Int).SetInt64(tt.args.pt))
			if (err != nil) != tt.wantErr {
...
func TestPublicKey_BatchAdd(t *testing.T) {
	...
	ct2, _ := pk.Encrypt(new(big.Int).SetInt64(2))
	ct3, _ := pk.Encrypt(new(big.Int).SetInt64(3))
	ct4, _ := pk.Encrypt(new(big.Int).SetInt64(4))
	ct5, _ := pk.Encrypt(new(big.Int).SetInt64(5))

	cap := 1000
	ctCAPx5 := make([]*big.Int, cap)
	for i := 0; i < cap; i++ {
		ctCAPx5[i], _ = pk.Encrypt(new(big.Int).SetInt64(5))
	}
	tests := []struct {
		name string
		args []*big.Int
...
func TestPublicKey_Sub(t *testing.T) {
	...
	c2, _ := pk.Encrypt(new(big.Int).SetInt64(2))
	c3, _ := pk.Encrypt(new(big.Int).SetInt64(3))
	c4, _ := pk.Encrypt(new(big.Int).SetInt64(4))
	c5, _ := pk.Encrypt(new(big.Int).SetInt64(5))
	c23578, _ := pk.Encrypt(new(big.Int).SetInt64(23578))
	c115, _ := pk.Encrypt(new(big.Int).SetInt64(115))
...
func TestPublicKey_DivPlaintext(t *testing.T) {
	...
	for _, tt := range tests {
		fmt.Println(tt)
		t.Run(tt.name, func(t *testing.T) {
			got, err := pk.DivPlaintext(tt.args.ct, new(big.Int).SetInt64(tt.args.pt))
			if (err != nil) != tt.wantErr {
